...
- RSpectra does converge, but provides results that look weird. This
  ...
  eigenvalues, which will then be returned in the wrong order.
- RSpectra hangs, doing nothing, very slowly increasing its memory
  usage. This seems to happen [during sparse
  factorization](https://github.com/yixuan/spectra/issues/126).
